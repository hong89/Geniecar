...
-- 답글 등록
INSERT INTO BOARD(NO, PARENT_NO, TITLE, CONTENT, HIT, TYPE_CODE, NOTICE_YN, HASH_TAG, FILE_NO, START_DATE, END_DATE, REG_ID, REG_DATE, MOD_ID, MOD_DATE) VALUES(SEQ_BOARD_NO.NEXTVAL, 161, '161댓글자식', '댓글자식내용', 0, 'QNA', 'N', NULL, 43, '2024/01/01', '2024/05/31', 'ADMIN', '2024-02-17', 'ADMIN', '2024/01/01');
INSERT INTO BOARD(NO, PARENT_NO, TITLE, CONTENT, HIT, TYPE_CODE, NOTICE_YN, HASH_TAG, FILE_NO, START_DATE, END_DATE, REG_ID, REG_DATE, MOD_ID, MOD_DATE) VALUES(SEQ_BOARD_NO.NEXTVAL, 165, '165댓글자식', '댓글자식내용', 0, 'QNA', 'N', NULL, 44, '2024/01/01', '2024/05/31', 'ADMIN', '2024-02-17', 'ADMIN', '2024/01/01');
INSERT INTO BOARD(NO, PARENT_NO, TITLE, CONTENT, HIT, TYPE_CODE, NOTICE_YN, HASH_TAG, FILE_NO, START_DATE, END_DATE, REG_ID, REG_DATE, MOD_ID, MOD_DATE) VALUES(SEQ_BOARD_NO.NEXTVAL, 168, '168댓글자식', '댓글자식내용', 0, 'QNA', 'N', NULL, 45, '2024/01/01', '2024/05/31', 'ADMIN', '2024-02-17', 'ADMIN', '2024/01/01');
INSERT INTO BOARD(NO, PARENT_NO, TITLE, CONTENT, HIT, TYPE_CODE, NOTICE_YN, HASH_TAG, FILE_NO, START_DATE, END_DATE, REG_ID, REG_DATE, MOD_ID, MOD_DATE) VALUES(SEQ_BOARD_NO.NEXTVAL, 174, '165댓글자식인 174댓글자식의 자식', '댓글자식내용', 0, 'QNA', 'N', NULL, 45, '2024/01/01', '2024/05/31', 'ADMIN', '2024-02-17', 'ADMIN', '2024/01/01');

UPDATE BOARD SET TITLE = '165댓글자식인 174댓글자식의 자식' WHERE NO = 176;
