...
<a itemprop="sameAs" href="https://blog.naver.com/official_lotterental"></a>
	...
	<link rel="stylesheet" href="/lrhp/pc/styles/reset.css?cb=8f1db205-014b-41f2-8bca-56345ae5d030">
	<link rel="stylesheet" href="/lrhp/pc/styles/layout.css?cb=8f1db205-014b-41f2-8bca-56345ae5d030">
	<link rel="stylesheet" href="/lrhp/pc/styles/modules.css?cb=8f1db205-014b-41f2-8bca-56345ae5d030">
	<link rel="stylesheet" href="/lrhp/pc/styles/contents.css?cb=8f1db205-014b-41f2-8bca-56345ae5d030">
	<link rel="stylesheet" href="/lrhp/pc/styles/jquery.mCustomScrollbar.css?cb=8f1db205-014b-41f2-8bca-56345ae5d030">
...
<script src="/publish/js/md5.js?cb=8f1db205-014b-41f2-8bca-56345ae5d030"></script>
<script src="/publish/js/cmmnUtil.js?cb=8f1db205-014b-41f2-8bca-56345ae5d030"></script>
<!-- SSO 고도화 -->
...
<script src="/lrhp/js/sso/sso.rental.js?cb=8f1db205-014b-41f2-8bca-56345ae5d030"></script>
<script src="/lrhp/js/sso/sso.rentacar.v2.js?cb=8f1db205-014b-41f2-8bca-56345ae5d030"></script>
<script src="/lrhp/js/sso/api.rentcar.js?cb=8f1db205-014b-41f2-8bca-56345ae5d030"></script>
<!-- Social Login -->
...
<script src="/lrhp/js/social/social.rentacar.js?cb=8f1db205-014b-41f2-8bca-56345ae5d030"></script>
<!-- kcb okcert -->
...
<script src="/lrhp/js/common/gfn_util.js?cb=8f1db205-014b-41f2-8bca-56345ae5d030"></script>
...
<script src="/lrhp/pc/scripts/adobe_analytics_tagging.js?cb=8f1db205-014b-41f2-8bca-56345ae5d030"></script>
<!-- Adobe Analytics End -->
	<!-- Adobe Analytics (temp)-->
<!-- <script src="https://assets.adobedtm.com/0d3d26a8f9f8/8ca38b3d4546/launch-eb7bb6609f87.min.js" async></script> -->
	<title>
...
<script type="text/javascript">
    $(function(){
        ...
        //
        _rentMembers.init({
            clientAkInfo: '{"clntEncKey":"bPq7zvsXYqXkeRsJ","flwNo":"VCUsC8EZBX","domain":"https://members.lpoint.com"}' || '',
			...
			<div class="inner-type2">
					...
					<div class="myInfos-area">
						<div class="box-between">
							<h3 class="txt">
								...
								<span>일반회원&nbsp;<button type="button" class="layer-mypage-open mr-btn" data-layer="member-rating">(총 대여횟수 0회)</button></span>
							</h3>
							<div class="btns">
						...
						<ul class="item-list">
							...
							<li>
								...
								<p>무료이용권</p>
								<a href="/hp/kor/myPage/coupon.do?tab=tab_2" class="underline" id="commonMemberShipCoupon">0장</a>
							</li>
							<li>
							...
							<li>
								...
								<p>렌터카 상담</p>
								<a  href="/hp/kor/myPage/rentCarConsulting.do" class="underline" id="commonRentalConsultCount">0건</a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="mypage-body">
					<div class="mypage-lnb">
						<ul>
							<li>
								<a href="/hp/kor/myPage/reservation.do" data-link-area="마이페이지" data-link-name="메뉴" data-link-text="단기렌터카 예약">단기렌터카 예약</a>
							</li>
							<li>
								<a href="/hp/kor/myPage/reservationMonth.do" data-link-area="마이페이지" data-link-name="메뉴" data-link-text="월간단기렌터카 예약">월간단기렌터카 예약</a>
							</li>
							<li>
								<a href="/hp/kor/myPage/reservationDriver.do" data-link-area="마이페이지" data-link-name="메뉴" data-link-text="기사포함단기렌터카 예약">기사포함단기렌터카 예약 </a>
							</li>
							<li>
							...
							<li>
								...
								<ul>
									<li>
											...
											<button onClick="_rentMembers.page.href('/myPage/member/kcb.do?type=modify')">회원정보 변경</button>
										
										
									</li>
									<li>
										
											<a href="javascript:_rentMembers.page.href('/myPage/member/kcb.do?type=password');">비밀번호 변경</a>
					...
					<div class="mypage-body-cont" >
								...
								<div class="nodata-card bg-card">
									...
									<div class="btn-box">
										<button type="button" class="btn btn-red" onclick="location.href = '/hp/kor/reservation/index.do?mnCd=T2FN0101';" data-link-area="마이페이지" data-link-name="메인" data-link-text="제주/내륙 렌터카 예약하기">제주/내륙 렌터카 예약하기</button>
									</div>
								</div>
							...
							<!-- 월간 단기렌터카 목록이 없을 경우는 표시하지 않음 -->
							
						
						
							
							
							<!-- 기사 포함 렌터카 목록이 없는 경우는 표시하지 않음 -->
						...
						<!-- 찜차량 리스트 호출 -->
								...
								<div class="list-section">
									...
									<div class="nodata-card">
										<h3 class="tit">차량 찜 등록하여 한곳에서 비교해 보세요.</h3>
										<p class="txt">중고차 장기렌터카에서 찜하신 차량이 없습니다.</p>
										<div class="btn-box">
											<button type="button" class="btn btn-black" onclick="location.href = '/hp/kor/usedCar/longTerm/usedCarList.do?mnCd=T2FN0301';">중고차장기렌터카 바로가기</button>
										</div>
									</div>
								</div>
						...
						<div class="card-between-section">
									...
									<!-- 관심차종이 없을 경우 -->
									<section class="nodata-card">
										<h4 class="tit">나의 관심 차종</h4>
										<p class="txt">
											관심 차종 중 새로운 차량이 등록되면<br>
											알림 메시지를 보내드립니다.
										</p>
										<div class="btn-box">
											<button type="button" class="btn btn-black" onclick="location.href = '/hp/kor/usedCar/longTerm/usedCarList.do?mnCd=T2FN0301';">중고차장기렌터카 바로가기</button>
										...
										<div class="btn-box">
											<button type="button" class="btn btn-red" onclick="location.href = '/hp/kor/myPage/interestCar.do';">설정</button>
										</div>
									</section>
									...
									<section class="nodata-card">
										...
										<div class="btn-box">
											<button type="button" class="btn btn-red" onclick="location.href='/hp/kor/reservation/index.do?mnCd=T2FN0101';" data-link-area="마이페이지" data-link-name="메뉴" data-link-text="단기렌터카 예약">단기렌터카 예약하기</button>
										</div>
									</section>
							...
							<!-- 장기렌터카 계약건이 없을 경우 -->
								...
								<!-- 최근본 중고차장기렌터카가 없을 경우 -->
								<div class="nodata-card">
									<h3 class="tit">최근 본 중고차장기렌터카</h3>
									<p class="txt">최근 본 중고차장기렌터카 차량이 없습니다.</p>
									<div class="btn-box">
										<button type="button" class="btn btn-black" onclick="location.href = '/hp/kor/usedCar/longTerm/usedCarList.do';">중고렌터카 바로가기</button>
									</div>
								</div>
								...
								<!-- 최근본 승계매물이 없을 경우 -->
								<div class="nodata-card">
									<h3 class="tit">최근 본 승계렌터카</h3>
									<p class="txt">최근 본 승계렌터카 차량이 없습니다.</p>
									<div class="btn-box">
										<button type="button" class="btn btn-black" onclick="location.href = '/hp/kor/usedCar/succession/index.do?mnCd=T2FN030202';">승계렌터카 바로가기</button>
									</div>
								</div>
					...
					<!-- //.mypage-body-cont -->
<input type="hidden" value="116394668" id="memberNoParam">
	<!-- 지점안내 레이어-->
	
<!-- 레이어명 // 열리고 닫는 이벤트용 -->
<div class="layer-wrap layer-popup layer-mypage layer-sel-branch" style="top: 0px; left: 142px; opacity: 0;">
	<div class="pop-inner">
		<div class="popup-top">
			<h4 id="vkgrpTx">강남지점안내</h4>
			<button type="button" class="layer-popup-close" data-layer="layer-sel-branch"><span class="icon pop-close">닫기 버튼</span></button>
		</div>
		<div class="popup-cont layer-iscroll" style="height: 664px; overflow-y: auto;">
			<div class="iscroll-in">
				<div class="map">
					<div class="cover" id="layer-sel-branch-map" style="width: 100%; height: 500px; position: relative; overflow: hidden;">
					</div>
				<dl class="infos">
					<dt>영업시간</dt>
			...
			<div class="popup-cont-bot-btns">
				<button type="button" class="btn btn-white layer-popup-close" data-layer="layer-sel-branch">확인</button>
			</div>
		</div>
	</div>
</div>
...
$(document).ready(function(){
	...
	<!-- 지점안내 레이어-->
	<!-- 네이버 맵과 클릭한 지점에 대한 div영역 종료  -->
	<script type="text/javascript" src="https://oapi.map.naver.com/openapi/v3/maps.js?ncpClientId=ea7w6if99d&submodules=geocoder"></script>
    <script src="/lrhp/js/web/hp/pc/myPage/main.js?ver=8f1db205-014b-41f2-8bca-56345ae5d030" type="text/javascript"></script>
					<!-- //.mypage-body-cont -->
				</div>
				<!-- //.mypage-body -->
			</div>
	...
	<div class="layer-wrap layer-popup layer-mypage layer-password-reenter-info mypage-popup-entry">
		<div class="pop-inner">
			...
			<div class="popup-cont layer-iscroll">
					...
					<div class="form-cont between-type">
						<div class="form-row">
							<div class="input-cont">
								<div class="inputT">
									<input type="password" id="mypage-popup-input" name="mypage-popup-input" placeholder="비밀번호를 입력해주세요." minlength="8" maxlength="15">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="popup-cont-bot-btns">
					<button type="button" class="btn btn-white layer-popup-close cancel" data-layer="layer-asianaMileageForm">취소</button>
					<button type="button" class="btn btn-red layer-popup-close next" data-layer="layer-asianaMileageForm">확인</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="layer-wrap layer-popup layer-mypage member-rating">
		<div class="pop-inner">
			...
			<div class="popup-cont">
				...
				<div class="popup-cont-bot-btns">
					<a href="https://www.lotterentacar.net/hp/kor/reservation/shortInfo/benefits.do" class="btn btn-red">회원혜택 바로가기</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="layer-wrap layer-infos layer-popup layer-certificate">
		<div class="pop-inner">
			<div class="popup-top">
				...
				<button type="button" class="layer-popup-close" data-layer="layer-certificate"><span class="icon pop-close">닫기 버튼</span></button>
			</div>
			<div class="popup-cont layer-iscroll">
				<div>
				...
				<div class="popup-cont-bot-btn">
					<button type="button" class="btn btn-white layer-popup-close" data-layer="layer-certificate">확인</button>
				</div>
			</div>
		</div>
	</div>
