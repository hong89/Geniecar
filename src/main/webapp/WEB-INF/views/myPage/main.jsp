<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<head>
		...
		<link rel="stylesheet"
			href="/lrhp/pc/styles/jquery.mCustomScrollbar.css?cb=8f1db205-014b-41f2-8bca-56345ae5d030">
			...
			<div class="mypage-container">
				<div class="inner-type2">
						...
						<div class="mypage-body-cont">
							...
							<div class="nodata-card bg-card">
								...
								<div class="btn-box">
									<button type="button" class="btn btn-red"
										...
										data-link-area="마이페이지" data-link-name="메인" data-link-text="제주/내륙 렌터카 예약하기">제주/내륙
										렌터카 예약하기</button>
								</div>
							</div>
								...
								<div class="nodata-card">
									...
									<div class="btn-box">
										<button type="button" class="btn btn-black"
											onclick="location.href = '/hp/kor/usedCar/longTerm/usedCarList.do?mnCd=T2FN0301';">중고차장기렌터카
											바로가기</button>
									</div>
								</div>
							</div>
							...
							<div class="card-between-section">
								...
								<section class="nodata-card">
									...
									<div class="btn-box">
										<button type="button" class="btn btn-red"
											onclick="location.href = '/hp/kor/myPage/interestCar.do';">설정</button>
									</div>
								</section>
								...
								<section class="nodata-card">
									...
									<div class="btn-box">
										<button type="button" class="btn btn-red"
											onclick="location.href='/hp/kor/reservation/index.do?mnCd=T2FN0101';"
											data-link-area="마이페이지" data-link-name="메뉴" data-link-text="단기렌터카 예약">단기렌터카
											예약하기</button>
									</div>
								</section>
							...
							<div class="nodata-card">
								...
								<div class="btn-box">
									<button type="button" class="btn btn-black"
										onclick="location.href = '/hp/kor/usedCar/longTerm/usedCarList.do';">중고렌터카
										바로가기</button>
								</div>
							</div>
							...
							<div class="nodata-card">
								...
								<div class="btn-box">
									<button type="button" class="btn btn-black"
										onclick="location.href = '/hp/kor/usedCar/succession/index.do?mnCd=T2FN030202';">승계렌터카
										바로가기</button>
								</div>
							</div>
					...
					<div class="selBranchSwiper-button-next">
						...
						<script src="/lrhp/js/web/hp/pc/myPage/main.js?ver=8f1db205-014b-41f2-8bca-56345ae5d030"
