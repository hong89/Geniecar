    ...
    <div class="p-5">
        <div class="inner-type2">
            <section class="text-center">
                <h1 class="pb-5 tit">렌터카 예약 내역</h1>
            </section>

            <div class="row pb-5">
                <form id="searchForm" action="rentReservation.do" method="get">
                    <div class="row">
                        <div class="col-5">
                            <div class="row">
            ...
            <table class="pt-5 table caption-top align-middle">
                ...
                <c:forEach var="res" items="${reservationList}">
                    <tr>
                        <td class="col">
                            <a href="/admin/rental/rentDetail.do?reservationNo=${res.reservationNo}">
                                    ${res.reservationNo}
                            </a>
                        </td>
        ...
        <div>
            ...
            <script>
                ...
                function movePage(currentPage) {
                    ...
                    var url = "/admin/rental/rentReservation.do";
                    var params = [];
