<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/lrhp/pc/styles/reset.css?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe">
        <link rel="stylesheet" href="/lrhp/pc/styles/layout.css?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe">
        <link rel="stylesheet" href="/lrhp/pc/styles/modules.css?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe">
        <link rel="stylesheet" href="/lrhp/pc/styles/contents.css?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe">
        <link rel="stylesheet"
            href="/lrhp/pc/styles/jquery.mCustomScrollbar.css?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe">
        ...
        <script src="/publish/js/md5.js?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe"></script>
        <script src="/publish/js/cmmnUtil.js?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe"></script>
        <!-- SSO 고도화 -->
        ...
        <script src="/lrhp/js/sso/sso.rental.js?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe"></script>
        <script src="/lrhp/js/sso/sso.rentacar.v2.js?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe"></script>
        <script src="/lrhp/js/sso/api.rentcar.js?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe"></script>
        <!-- Social Login -->
        ...
        <script src="/lrhp/js/social/social.rentacar.js?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe"></script>
        <!-- kcb okcert -->
        ...
        <script src="/lrhp/js/common/gfn_util.js?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe"></script>
        ...
        <script src="/lrhp/pc/scripts/adobe_analytics_tagging.js?cb=4b272b11-b2d8-42f6-ab09-53c5ab7102fe"></script>
        <!-- Adobe Analytics End -->
        <!-- Adobe Analytics (temp)-->
        <!-- <script src="https://assets.adobedtm.com/0d3d26a8f9f8/8ca38b3d4546/launch-eb7bb6609f87.min.js" async></script> -->
        <title>
                ...
                <div class="inner-type2">
                    ...
                    <div class="mypage-body">
                        ...
                        <div class="container" data-id="template-container">
                            <div class="mypage-body-cont password-lpoint">
                                <div class="mypage-body-cont-header">
                                    <div class="tit-area">
                                        <h4 class="tit">비밀번호 변경</h4>
                                    </div>
                                    <ul class="icon-guide-area">
                                        <li><span class="icon talk3"></span>
                                ...
                                <div class="section-form type2">
                                    <div class="form-cont">
                                        <div class="row type2">
                                            <label for="" class="input-tit">새 비밀번호</label>
                                            <div class="input-cont">
                                                <div class="inputT">
                                                    <input type="password" id="member-password-1st"
                                                        name="member-password-1st" placeholder="새 비밀번호를 입력해주세요."
                                                        maxlength="15" />
                                                </div>
                                                <p class="txt-valid txt-color-red">8~15자리의 영문/숫자/특수문자를 함께 입력해주세요.</p>
                                            </div>
                                        </div>
                                        <div class="row type2">
                                            <label for="" class="input-tit">새 비밀번호 확인</label>
                                            <div class="input-cont">
                                                <div class="inputT">
                                                    <input type="password" id="member-password-2nd"
                                                        name="member-password-2nd" placeholder="입력하신 비밀번호를 다시 입력해주세요."
                                                        maxlength="15" />
                                                </div>
                                            </div>
                                        </div>
                                        <ul class="lst dot mt-20">
                                            <li>비빌번호 입력 시 아래 규칙을 참고해주세요.
                                                <ul class="lst num num03">
                                                    <!-- 
							<li><span class="bul">1</span> 비밀번호는 영문자, 숫자, 특수기호의 조합으로 8~15자리를 사용해야 합니다.</li>
							<li><span class="bul">2</span> 특수기호는 ! @ # $ % ^ * ? _ ~ 만 사용가능 합니다.</li>
							<li><span class="bul">3</span> 연속된 문자열을 3자리 이상 사용할 수 없습니다.</li>
							<li><span class="bul">4</span> 동일한 문자을을 3자리 이상 사용할 수 없습니다.</li>
							-->
                                                    <li><span class="bul">1</span> 영문+숫자+특수문자 조합으로 8~15자리를 입력해야 합니다.
                                                    </li>
                                                    <li><span class="bul">2</span> 특수기호는 ! @ # $ % ^ * ? _ ~ 만 사용가능 합니다.
                                                    </li>
                                                    <li><span class="bul">3</span> 동일한 문자열을 3자 이상 사용할 수 없습니다.</li>
                                                    <li><span class="bul">4</span> 연속된 문자열을 3자 이상 사용할 수 없습니다. (역순 포함)
                                                    </li>
                                                    <li><span class="bul">5</span> 키보드상 연속문자열을 사용할 수 없습니다.</li>
                                                    <li><span class="bul">6</span> 아이디와 동일한 문자열을 3자이상 사용하실 수 없습니다.</li>
                                                    <li><span class="bul">7</span> 휴대폰번호와 동일한 문자열을 3자이상 사용하실 수 없습니다.
                                                    </li>
                                                    <li><span class="bul">8</span> 이름(사업자명)과 동일한 문자열을 3자이상 사용하실 수 없습니다.
                                                    </li>
                                                    <li><span class="bul">9</span> 전화번호(국번)와 동일한 문자열을 3자이상 사용하실 수 없습니다.
                                                    </li>
                                                    <li><span class="bul">10</span> 생년월일과 동일한 문자열을 4자이상 사용하실 수 없습니다.
                                                    </li>
                                                    <li><span class="bul">11</span> 사업자번호와 동일한 문자열을 3자이상 사용하실 수 없습니다.
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                            ...
                            <!-- //.mypage-body-cont -->
                            <script
                                src="/lrhp/js/web/hp/pc/myPage/memberPassword.js?ver=4b272b11-b2d8-42f6-ab09-53c5ab7102fe"
                                type="text/javascript"></script>
                            <script>
                                $(function () {
                                    _mypageMemberPassword.init({
                                        active: "lpoint",
                                        ci: "L4DYVY4BbHb+7w8Y5RacwMJIZfCvN5idZP82/vIWxS92uUWDih73TCS6lBscNIxynUJRObidKrdQ5CvnrujgqA==" || "",
                                        onlId: "ruddud2284@gmail.com" || ""
                                    });
                                });
                            </script>
                        </div>
