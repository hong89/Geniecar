						...
						<article class="p-5 container-fluid">
                            ...
                            <div class="p-3">
                                <ul class="nav nav-pills nav-fill pb-3 border-bottom" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="contact-tab2" data-bs-toggle="tab" data-bs-target="#contact2" type="button" role="tab" aria-controls="contact2" aria-selected="false">결제대기</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="contact-tab3" data-bs-toggle="tab" data-bs-target="#contact3" type="button" role="tab" aria-controls="contact3" aria-selected="false">계약완료</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="contact-tab4" data-bs-toggle="tab" data-bs-target="#contact4" type="button" role="tab" aria-controls="contact4" aria-selected="false">이용중</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="contact-tab5" data-bs-toggle="tab" data-bs-target="#contact5" type="button" role="tab" aria-controls="contact5" aria-selected="false">이용완료</button>
                                     </li>
                                    <li class="nav-item" role="presentation">
                                      <button class="nav-link" id="contact-tab6" data-bs-toggle="tab" data-bs-target="#contact6" type="button" role="tab" aria-controls="contact6" aria-selected="false">취소</button>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active border-bottom" id="contact1" role="tabpanel" aria-labelledby="contact-tab1">
                                        <div class="text-center mt-3 mb-3 pd-5 ">
                                            <h5><br><br><br><br>단기렌터카 예약 내역이 없습니다.<br><br><br><br></h5>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade border-bottom" id="contact2" role="tabpanel" aria-labelledby="contact-tab2">.2..</div>
                                    <div class="tab-pane fade border-bottom" id="contact3" role="tabpanel" aria-labelledby="contact-tab3">.3..</div>
                                    <div class="tab-pane fade border-bottom" id="contact4" role="tabpanel" aria-labelledby="contact-tab4">.4..</div>
                                    <div class="tab-pane fade border-bottom" id="contact5" role="tabpanel" aria-labelledby="contact-tab5">.5..</div>
                                    <div class="tab-pane fade border-bottom" id="contact6" role="tabpanel" aria-labelledby="contact-tab6">.6..</div>
                                    <ul class="mt-3 lh-lg"">
