    ...
    <div class="footer-link">
        <div class="inner">
            <ul>
                ...
                <li>
                    <a href="https://www.lotte-autolease.com" onclick="ga('send', 'event', '풋터', '패밀리사이트', '오토리스랜딩');"
                       target="_blank">롯데오토리스</a>
                </li>
                <li>
                    <a href="#n"
            ...
            <div class="family">
                <button type="button" class="btn btn-family family-btn" data-target="family-cont-01" data-on="true"
                        data-siblings="true">FAMILY SITE
                </button>
        ...
        <div class="footer-bottom-menu">
            <div class="footer-infos-wrap">
                <div class="sitemap">
                    <ul>
                        ...
                        <li><a href="/hp/kor/terms/videoInfo.do" class="txt_point" target="_self">영상정보처리기기 운영관리방침</a>
                        </li>
                            ...
                            <li>
                                ...
                                <ul class="address">
                                    ...
                                    <li>사업자등록번호 : <a
                                            ...
                                            class="btn_entrepreneur_info">214-87-79183</a> / 통신판매업신고번호 : 제2010-경기안양-420호
                                    </li>
            ...
            <div class="footer-app-wrap">
                ...
                <ul>
                    ...
                    <li>
                        <a href="https://apps.apple.com/kr/app/%EB%A1%AF%EB%8D%B0%EB%A0%8C%ED%84%B0%EC%B9%B4/id405947384"
